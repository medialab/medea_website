(function(venn) {
  ...
  venn.plotGlobalAR = function(container, width, height) {
    ...
    d3.select(d3.select(container).node().parentNode).select('h4')
      .html('Distribution of IPCC authors among the 3 WGs - all ARs aggregated');
  ...
  venn.plotAnnualARs = function(container, width, height) {
    ...
    d3.select(d3.select(container).node().parentNode).select('h4')
      .html('Distribution of IPCC authors among the 3 WGs - ARs separated');
