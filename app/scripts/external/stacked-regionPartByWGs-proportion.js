(function(undefined) {
  ...
  /**
   * MEDEA StackedBarsRegionPartProportionByWGs Viz
   * ================
   *
   * Load the participations.json file and display the relevant "stackedBars" diagram
   */
  function StackedBarsRegionPartProportionByWGs() {
    //Properties
    this.data = null;
  ...
  StackedBarsRegionPartProportionByWGs.prototype.load = function(path, callback) {
    var self = this;
  ...
  StackedBarsRegionPartProportionByWGs.prototype.drawViz = function(container, params) {
  ...
  StackedBarsRegionPartProportionByWGs.prototype.updateData = function(container, params) {
    var height = params.height || this.defaultHeight,
        width = params.width || this.defaultWidth,
        margin = params.margin || this.defaultMargin,
  ...
  if (typeof exports !== 'undefined') {
    if (typeof module !== 'undefined' && module.exports)
      exports = module.exports = StackedBarsRegionPartProportionByWGs;
    exports.StackedBarsRegionPartProportionByWGs = StackedBarsRegionPartProportionByWGs;
  } else if (typeof define === 'function' && define.amd)
    define('StackedBarsRegionPartProportionByWGs', [], function() {
      return StackedBarsRegionPartProportionByWGs;
    });
  else
    this.StackedBarsRegionPartProportionByWGs = StackedBarsRegionPartProportionByWGs;
